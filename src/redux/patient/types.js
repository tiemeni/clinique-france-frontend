...
export const UPDATE_PATIENT_FINISHED = 'UPDATE_PATIENT_FINISHED'
...
export const SEARCH_PATIENT_FAILLED = 'SEARCH_PATIENT_FAILLED';

export const CLEAR_ALL_ERR_MSG = 'CLEAR_ALL_ERR_MSG';
